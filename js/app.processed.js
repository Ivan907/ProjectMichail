	  ...
	  _createClass(App, [{
	    ...
	    value: function render() {
	      return React.createElement(
	        ...
	        React.createElement(_ShowCase2.default, { title: "Храм Рождества Христова", image: "https://github.com/Ivan907/ProjectMichail/image/37655_20230826_1704031.jpg", description: "Собор был назван в честь разрушенного советской властью около ста лет назад собора Рождества Христова. Высота здания вместе с крестом — почти 74 метра. В архитектурном решении собора доминируют мотивы классицизма. Кафедральный собор призван стать украшением города и «визитной карточкой» Челябинской митрополии. Возведение собора — предмет неустанной заботы правящего архиерея."}),
	      ...
	      return React.createElement(
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            "a",
	            { href: "#" },
	            "Сайт разработан в качестве проектного продукта Автор проекта: Санников Михаил"
	          ),
	        )
	      );
	    }
