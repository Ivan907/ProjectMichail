	  ...
	  _createClass(App, [{
	    ...
	    value: function render() {
	      return React.createElement(
	        ...
	        React.createElement(_ShowCase2.default, { title: "Храм Николая Чудотворца", image: "https://ivan907.github.io/ProjectMichail/image/5649110_2000.jpg", description: ["Свято-Никольский храм был построен в 1948 году. Освящен в честь святого Николая Мирликийского.", React.createElement("br"), React.createElement("br"), "Адрес: Россия, Челябинская область, г. Пласт, пер. Чехова, 9", React.createElement("br"), React.createElement("br"), React.createElement("a", { href: "https://vk.com/hram_svat_nik?offset=10&own=1", target: "_blank", rel: "noopener noreferrer" }, "Подробнее")]}),
		React.createElement(_ShowCase2.default, { title: "Храм Вознесения Господня", image: "https://ivan907.github.io/ProjectMichail/image/35428_20150721_021225.jpg", description: ["Храм Вознесения Господня построили в 1863 г. В советское время храм закрыли за одну ночь. В 2003 году начались работы по восстановлению и 17 декабря 2005 г. в храме прошла первая служба.", React.createElement("br"), React.createElement("br"), "Адрес: Россия, Челябинская область, Пластовский район, село Кочкарь, ул. Библиотечная, 16", React.createElement("br"), React.createElement("br"), React.createElement("a", { href: "https://vk.com/public140505147", target: "_blank", rel: "noopener noreferrer" }, "Подробнее")]}),
		React.createElement(_ShowCase2.default, { title: "Храм Святой Варвары", image: "https://ivan907.github.io/ProjectMichail/image/49102_20240603_0238430.jpg", description: ["Строительство храма начато в 2019 году по инициативе президента ЮГК К.И. Струкова. 11 октября 2024 года состоялось освящение храма в честь святой великомученицы Варвары, покровительнице шахтеров и горняков.", React.createElement("br"), React.createElement("br"), "Адрес: Россия, Челябинская область, г. Пласт, Заводская улица, 1а", React.createElement("br"), React.createElement("br"), React.createElement("a", { href: "https://vk.com/hramplast", target: "_blank", rel: "noopener noreferrer" }, "Подробнее")]})
	      );
	    }
	  }]);
	      ...
	      return React.createElement(
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            ...
	            { href: "#" },
	            [
      "Сайт создан для защиты индивидуального проекта в 7 классе",
      React.createElement("br"),
      "Автор проекта: Санников Михаил"
    ]
	          ),
	        )
	      );
...
/***/ (function(module, exports) {
  ...
  function ShowCase(props) {
    ...
    // Изначально устанавливаем image из props
    _this.state = {
  ...
  _createClass(ShowCase, [{
    ...
    value: function render() {
      ...
      return React.createElement(
        "div",
        { 
          className: "showcase_container type1", 
          style: { backgroundImage: "url(" + this.state.image + ")" } // Используем image из state, который уже установлен из props
        },
        React.createElement(
          "div",
